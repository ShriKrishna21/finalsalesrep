...
class unittotalstaffattendance extends StatefulWidget {
  final int userid;

  const unittotalstaffattendance({super.key, required this.userid});

  @override
  State<unittotalstaffattendance> createState() => _unittotalstaffattendanceState();
}

class _unittotalstaffattendanceState extends State<unittotalstaffattendance> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Total Attendance - ${widget.userid ?? 'Unknown'}"),
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Text(
                "Total's attendance details for ${widget.userid ?? 'Unknown'}",
