        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _detailRow(localizations.subscribed, _formatBool(r.eenaduNewspaper)),
              _detailRow(localizations.freeoffer, _formatBool(r.freeOffer15Days)),
              _detailRow(localizations.readnewspaper, _formatBool(r.readNewspaper)),
              _detailRow(localizations.reasonfornottakingoffer, r.reasonNotTakingOffer ?? ''),
              ...
              Padding(
                ...
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text("Location URL: ", style: TextStyle(fontWeight: FontWeight.w600)),
                    Expanded(
                      child: InkWell(
                        onTap: () {
                          openGoogleMaps(
